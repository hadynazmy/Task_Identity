...
namespace TaskEngAmr.Areas.Identity.Pages.Account
{
    ...
    {
        private readonly UserManager<ApplicationUser> _userManager;  // إضافة _userManager هنا
        private readonly SignInManager<ApplicationUser> _signInManager;
        private readonly ILogger<LoginModel> _logger;

        // تعديل constructor ليشمل UserManager
        public LoginModel(SignInManager<ApplicationUser> signInManager,
                          UserManager<ApplicationUser> userManager,
                          ILogger<LoginModel> logger)
        {
            _signInManager = signInManager;
            _userManager = userManager; // حقن _userManager
            _logger = logger;
        }
